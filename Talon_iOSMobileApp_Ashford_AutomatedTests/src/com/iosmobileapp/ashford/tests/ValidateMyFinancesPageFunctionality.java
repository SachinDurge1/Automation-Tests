...
public class ValidateMyFinancesPageFunctionality {
	...
	@Test
	public void validateMyFinancesPageFunctionality() throws IOException, InterruptedException
	{
		...
		//click on the "Account Info" field in My Finance Page..
		MyFinancesPage.clickAccountInfoTab();
		
		// Get the Existence of the "My Finances" Header  in the My Finance page..
		isMyFinances_exists = MyFinancesPage.isMyFinancesHeader_Exists();
		// Assert to validate the "My Finances" exists successfully.
		Assert.assertTrue(isMyFinances_exists,"Expected My Finances header in My Finance page; Actually not found");
		
		//click on the "FA Status" field in My Finance Page..
		MyFinancesPage.clickFAStatusTab();
